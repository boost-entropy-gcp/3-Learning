...
public class Modify {
    public static void main(String[] args) {
        ...
        // Using 4 lines of code, multiply each of the elements in the 2x2 top left corner of intMatrix by 5 and
        // store the results in the subMatrix you created. Afterwards, uncomment the provided print statement below.
